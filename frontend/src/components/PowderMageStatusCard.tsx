      ...
      <CardContent>
        <div className="flex items-center justify-around text-center">
          <div>
            ...
            <p className="text-micro font-tome-marginalia text-muted-foreground uppercase">Casting Timer</p>
          </div>
          <div>
            <p className="text-2xl font-display text-primary">{speedDialSlots}</p>
            <p className="text-micro font-tome-marginalia text-muted-foreground uppercase">Speed Dial Slots</p>
          </div>
        </div>
