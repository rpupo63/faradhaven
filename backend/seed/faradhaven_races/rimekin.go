...
func rimekinSpellcastingOptions() []TraitOptionSeed {
	return []TraitOptionSeed{
		{
			Name:        "Intelligence",
			Description: "Intelligence is your spellcasting ability for Ray of Frost, Ice Knife, and Flame Blade when you cast them with this trait.",
		},
		{
			Name:        "Wisdom",
			Description: "Wisdom is your spellcasting ability for Ray of Frost, Ice Knife, and Flame Blade when you cast them with this trait.",
		},
		{
			Name:        "Charisma",
			Description: "Charisma is your spellcasting ability for Ray of Frost, Ice Knife, and Flame Blade when you cast them with this trait.",
		},
	}
}
