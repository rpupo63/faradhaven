...
func tieflingFiendishLegacyOptions() []TraitOptionSeed {
	return []TraitOptionSeed{
		{
			Name:        "Abyssal",
			Description: "You have Resistance to Poison damage. You also know the Poison Spray cantrip. When you reach character level 3, you learn the Ray of Sickness spell. When you reach character level 5, you learn the Hold Person spell. You always have these spells prepared. You can cast each once without a spell slot, and you regain the ability to cast them in that way when you finish a Long Rest. You can also cast them using any spell slots you have of the appropriate level.",
		},
		{
			Name:        "Chthonic",
			Description: "You have Resistance to Necrotic damage. You also know the Chill Touch cantrip. When you reach character level 3, you learn the False Life spell. When you reach character level 5, you learn the Ray of Enfeeblement spell. You always have these spells prepared. You can cast each once without a spell slot, and you regain the ability to cast them in that way when you finish a Long Rest. You can also cast them using any spell slots you have of the appropriate level.",
		},
		{
			Name:        "Infernal",
			Description: "You have Resistance to Fire damage. You also know the Fire Bolt cantrip. When you reach character level 3, you learn the Hellish Rebuke spell. When you reach character level 5, you learn the Darkness spell. You always have these spells prepared. You can cast each once without a spell slot, and you regain the ability to cast them in that way when you finish a Long Rest. You can also cast them using any spell slots you have of the appropriate level.",
		},
	}
}
