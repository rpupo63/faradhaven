...
func Tiefling() FaradhavenRaceSeed {
	return FaradhavenRaceSeed{
		...
		Traits:         tieflingTraits(),
		        ComponentNames: []string{"Arcanum", "Self", "Mortis", "Projectile", "Beam", "Decrease", "Extreme", "Increase", "Ignis", "Nova", "Umbra", "Zone"},
		    }
		}
		...
		func tieflingFiendishLegacyOptions() []TraitOptionSeed {
		    return []TraitOptionSeed{
		        {
		            Name:        "Abyssal",
		            Description: "You have Resistance to Poison damage. You also know the Mortis + Projectile component combination (a spray of decay). When you reach character level 3, you learn Mortis + Beam (a ray of sickening energy). When you reach character level 5, you learn Decrease + Extreme (complete stasis). You always have these component combinations prepared. You can cast each once without a spell slot, and you regain the ability to cast them in that way when you finish a Long Rest. You can also cast them using any spell slots you have of the appropriate level.",
		        },
		        {
		            Name:        "Chthonic",
		            Description: "You have Resistance to Necrotic damage. You also know the Mortis + Projectile component combination (spectral cold touch). When you reach character level 3, you learn Increase + Self (bolstering your own vitality with false life). When you reach character level 5, you learn Decrease + Beam (a ray that weakens your foes). You always have these component combinations prepared. You can cast each once without a spell slot, and you regain the ability to cast them in that way when you finish a Long Rest. You can also cast them using any spell slots you have of the appropriate level.",
		        },
		        {
		            Name:        "Infernal",
		            Description: "You have Resistance to Fire damage. You also know the Ignis + Projectile component combination (a bolt of fire). When you reach character level 3, you learn Ignis + Nova (fiery retribution when struck). When you reach character level 5, you learn Umbra + Zone (an area of magical darkness). You always have these component combinations prepared. You can cast each once without a spell slot, and you regain the ability to cast them in that way when you finish a Long Rest. You can also cast them using any spell slots you have of the appropriate level.",
		        },
		    }
		}
