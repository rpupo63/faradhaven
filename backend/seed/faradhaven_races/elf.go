...
func elfLineageOptions() []TraitOptionSeed {
	return []TraitOptionSeed{
		{
			Name:        "Drow",
			Description: "Level 1: The range of your Darkvision increases to 120 feet. You also know the Dancing Lights cantrip. Level 3: Faerie Fire. Level 5: Darkness.",
		},
		{
			Name:        "High Elf",
			Description: "Level 1: You know the Prestidigitation cantrip. Whenever you finish a Long Rest, you can replace that cantrip with a different cantrip from the Wizard spell list. Level 3: Detect Magic. Level 5: Misty Step.",
		},
		{
			Name:        "Wood Elf",
			Description: "Level 1: Your Speed increases to 35 feet. You also know the Druidcraft cantrip. Level 3: Longstrider. Level 5: Pass without Trace.",
		},
		{
			Name:        "Lorwyn Elf",
			Description: "Level 1: You know the Thorn Whip cantrip. Whenever you finish a Long Rest, you can replace that cantrip with a different cantrip from the Druid spell list. Level 3: Command. Level 5: Silence.",
		},
		{
			Name:        "Shadowmoor Elf",
			Description: "Level 1: The range of your Darkvision increases to 120 feet. You also know the Starry Wisp cantrip. Level 3: Heroism. Level 5: Gentle Repose.",
		},
	}
}
