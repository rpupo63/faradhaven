	...
	return []TraitOptionSeed{
		{
			...
			Description: "As a Bonus Action, you magically displace yourself up to 30 feet to an unoccupied space you can see.",
		},
		{
			Name:        "Fire's Burn (Fire Giant)",
			Description: "When you hit a target with an attack roll and deal damage to it, you can deal an extra 1d10 Fire damage to that target.",
		},
		{
			Name:        "Frost's Chill (Frost Giant)",
			Description: "When you hit a target with an attack roll and deal damage to it, you can deal an extra 1d6 Cold damage to that target and reduce its Speed by 10 feet until the start of your next turn.",
		},
		{
