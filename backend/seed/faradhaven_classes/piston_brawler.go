...
func PistonBrawler() FaradhavenClassSeed {
	...
	return FaradhavenClassSeed{
		...
		ResourceDefinitions: []ResourceDefinitionSeed{
			...
			{Key: "speed_dial_slots", DisplayName: "Blueprint Slots", Category: "slot_count", Description: "Number of pre-calculated component combinations for quick casting", DisplayOrder: 2},
		},
