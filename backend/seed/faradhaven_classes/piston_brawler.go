...
func PistonBrawler() FaradhavenClassSeed {
	...
	return FaradhavenClassSeed{
		...
		PhotoURL:            seedmedia.URL("piston_brawler.jpg"),
		...
		ResourceDefinitions: []ResourceDefinitionSeed{
			...
			{Key: "speed_dial_slots", DisplayName: "Blueprint Slots", Category: "slot_count", Description: "Pre-calculated component combinations for quick casting. Click a slot to mark it used; restores on rest.", IsTrackable: true, RestoreOnShortRest: true, RestoreOnLongRest: true, DisplayOrder: 2},
		},
		ComponentPool: []string{
			// Forma (Shape)
			"Projectile", "Beam", "Nova", "Cone", "Zone", "Aura",
			// Scopus (Targeting)
			"Target", "Self", "Ground",
			// Essentia (Matter & Energy)
			"Ignis", "Fulgur", "Ferrum", "Aer", "Arcanum", "Sonus",
			// Actio (Verbs)
			"Push", "Pull", "Crush", "Pierce", "Spin", "Bind",
			// Magnitudo (Modifiers)
...
func pistonBrawlerLevelProgression() map[int]ClassLevelSeed {
	...
	return map[int]ClassLevelSeed{
		1:  {MaxSpellLevel: 1, Resources: map[string]int{"max_stability": 5}},
		2:  {MaxSpellLevel: 1, Resources: map[string]int{"max_stability": 5}},
		3:  {MaxSpellLevel: 1, Resources: map[string]int{"max_stability": 5}},
		4:  {MaxSpellLevel: 1, Resources: map[string]int{"max_stability": 6}},
		5:  {MaxSpellLevel: 2, ExtraAttackCount: 1, Resources: map[string]int{"max_stability": 7}},
		6:  {MaxSpellLevel: 2, ExtraAttackCount: 1, Resources: map[string]int{"max_stability": 7}},
		7:  {MaxSpellLevel: 2, ExtraAttackCount: 1, Resources: map[string]int{"max_stability": 7}},
		8:  {MaxSpellLevel: 2, ExtraAttackCount: 1, Resources: map[string]int{"max_stability": 7}},
		9:  {MaxSpellLevel: 3, ExtraAttackCount: 1, Resources: map[string]int{"max_stability": 8}},
		10: {MaxSpellLevel: 3, ExtraAttackCount: 1, Resources: map[string]int{"max_stability": 8}},
		11: {MaxSpellLevel: 3, ExtraAttackCount: 1, Resources: map[string]int{"max_stability": 8}},
		12: {MaxSpellLevel: 3, ExtraAttackCount: 1, Resources: map[string]int{"max_stability": 9}},
		13: {MaxSpellLevel: 4, ExtraAttackCount: 1, Resources: map[string]int{"max_stability": 10, "speed_dial_slots": 3}},
		14: {MaxSpellLevel: 4, ExtraAttackCount: 1, Resources: map[string]int{"max_stability": 10, "speed_dial_slots": 3}},
		15: {MaxSpellLevel: 4, ExtraAttackCount: 1, Resources: map[string]int{"max_stability": 10, "speed_dial_slots": 3}},
		16: {MaxSpellLevel: 4, ExtraAttackCount: 1, Resources: map[string]int{"max_stability": 10, "speed_dial_slots": 3}},
		17: {MaxSpellLevel: 5, ExtraAttackCount: 1, Resources: map[string]int{"max_stability": 11, "speed_dial_slots": 4}},
		18: {MaxSpellLevel: 5, ExtraAttackCount: 1, Resources: map[string]int{"max_stability": 11, "speed_dial_slots": 4}},
		19: {MaxSpellLevel: 5, ExtraAttackCount: 1, Resources: map[string]int{"max_stability": 11, "speed_dial_slots": 4}},
		20: {MaxSpellLevel: 5, ExtraAttackCount: 1, Resources: map[string]int{"max_stability": 20, "speed_dial_slots": 5}},
	}
}
...
func pistonBrawlerLevelFeatures() map[int][]FeatureSeed {
	return map[int][]FeatureSeed{
		...
		9:  {{Name: "High-Pressure Output", Description: "Your Max Spell Level increases to 3rd. You can now craft more complex component combinations such as [Haste + Self] for personal acceleration or [Rupture + Arcanum + Nova] for an arcane shockwave."}},
		...
		13: {{Name: "Advanced Calibration", Description: "Your Max Spell Level increases to 4th. You gain 3 Blueprint Slots, allowing you to pre-calculate component combinations during short or long rests for instant casting in combat."}},
		...
		17: {{Name: "Masterwork Engineering", Description: "Your Max Spell Level increases to 5th. You automatically regain all Stability Charges when you finish a short rest (once per long rest). Your Blueprint Slots increase to 4."}},
