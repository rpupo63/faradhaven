...
func Sanguinist() FaradhavenClassSeed {
	return FaradhavenClassSeed{
		...
		StartingEquip: []string{"Rapier or scimitar", "Leather armor", "Healer's kit", "3 blood vials (empty)"},
...
func sanguinistLevelFeatures() map[int]string {
	return map[int]string{
		...
		3:  "Subclass — Choose Path of the Doctor (The Reformer) or Path of the Beast (The Desolator). Doctor: Medical Prodigy—proficiency in Medicine; when you heal an ally, they also gain temporary hit points. Beast: Blood Rage—when you Siphon an ally, your weapon attacks deal an extra 1d8 necrotic damage for the buff's duration.",
		...
		10: "Subclass Feature — Path of the Doctor: Transfusion—when you take damage, you can use your reaction to spend 1 Ichor and grant an ally within 30 feet healing equal to half the damage you took. Path of the Beast: Abyss—spend 6 Ichor to transform into a shadow avatar for 1 minute. You gain resistance to all damage and can move through spaces as small as 1 inch.",
